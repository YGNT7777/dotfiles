...
static const char col_lightred[]    = "#CC6666";
static const char col_red[] 	    = "#A54242";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_lightred,  col_lightred  },
};
...
static const Key keys[] = {
	...
	{ MODKEY,             		XK_Return, spawn,          {.v = termcmd } },
        ...
        { MODKEY|ShiftMask,             XK_f,      spawn, 	   SHCMD("flameshot full -p ~/Pictures") },
